...
const PACK_CATALOG = Object.freeze({
  quick_wins:             { name: 'Quick Wins',              cost: 15,  minPlan: 'free',    category: 'fix',      description: 'Low-effort, high-impact fixes',                requiresAI: true  },
  faq_pack:               { name: 'FAQ Pack',                cost: 35,  minPlan: 'free',    category: 'fix',      description: 'Industry-specific FAQ schema + content',       requiresAI: true  },
  evidence_trust:         { name: 'Evidence / Trust',        cost: 40,  minPlan: 'free',    category: 'fix',      description: 'Trust signals, citations, authority markers',  requiresAI: true  },
  entity_clarity:         { name: 'Entity Clarity',          cost: 45,  minPlan: 'free',    category: 'fix',      description: 'Entity disambiguation + schema',               requiresAI: true  },
  schema_pack:            { name: 'Schema Pack',             cost: 60,  minPlan: 'free',    category: 'fix',      description: 'Full JSON-LD schema generation',               requiresAI: true  },
  content_brief:          { name: 'Content Brief',           cost: 30,  minPlan: 'free',    category: 'create',   description: 'AI-optimized content brief',                   requiresAI: true  },
  ...
  ai_ready_draft:         { name: 'AI-Ready Draft',          cost: 80,  minPlan: 'free',    category: 'create',   description: 'Full draft optimized for AI consumption',      requiresAI: true  },
  audit_pdf:              { name: 'Audit PDF',               cost: 10,  minPlan: 'free',    category: 'research', description: 'Downloadable scan report',                     requiresAI: false },
  refresh:                { name: 'Refresh',                 cost: 20,  minPlan: 'free',    category: 'research', description: 'Re-run scan + version comparison',             requiresAI: true  },
  citation_lift:          { name: 'Citation Lift',           cost: 45,  minPlan: 'free',    category: 'research', description: 'Citation improvement recommendations',         requiresAI: true  },
  query_refresh:          { name: 'Query Refresh',           cost: 60,  minPlan: 'free',    category: 'research', description: 'Re-run + version query baseline',              requiresAI: true  },
  ...
  query_baseline_starter: { name: 'Query Baseline Starter',  cost: 90,  minPlan: 'free',    category: 'research', description: 'Custom prompt set for monitoring',             requiresAI: true  },
